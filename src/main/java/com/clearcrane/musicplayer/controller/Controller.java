...
public class Controller {
    ...
    public void startWork() {
        ...
        mMusicManager.setOnProgressListener(this::onMusicProgress);
    }
     ...
     * 音乐播放状态上报
     */
    private void onMusicProgress(IMusicManager.Music music, int progress, int duration) {
        if (!mSocketConnected) {
    ...
    public void onMusicListGot(String response) {
        ...
        List<IMusicManager.Music> playList = new ArrayList<>();
        for (GetMusicListResponse.Musics music : musicList.Musics) {
            IMusicManager.Music m = new IMusicManager.Music();
